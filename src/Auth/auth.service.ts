...
import { UserDocument, UserInputDto, UserModel } from '../users/users.entity';
import { UsersService } from '../users/users.service';
import { JwtService } from '@nestjs/jwt';
import { EmailAdapter } from './emailAdapter/email-adapter';
import { BcryptService } from './bcryptAdapter/bcrypt.service';
...
export class AuthService {
  ...
  async registrationInSystem(body: UserInputDto): Promise<void> {
    ...
    await this.usersService.findUserForCreatUser(body.login);
    await this.usersService.findUserByEmail(body.email);
